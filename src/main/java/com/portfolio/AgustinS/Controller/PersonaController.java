...
import com.portfolio.AgustinS.Service.ImpPersonaService;
import com.portfolio.AgustinS.dto.Mensaje;
import com.portfolio.AgustinS.dto.dtoPersona;
...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoedu){
        ...
        if(personaService.existsByNombreE(dtoedu.getNombreE()))
